...
ROOT = HERE.parent
OUT  = ROOT / "results" / "pbnbv_orbit45_constrained_path.json"

ORBIT_N_AZ = 24      # 궤도 방위 수 (균등 원형)
...
def main():
    ...
    out = {
        "algorithm": f"Consistent tilt45 Orbit ({ORBIT_N_AZ}) + Constrained PB-NBV (overlap>={TAU_OVL})",
